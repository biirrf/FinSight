...
<head>
    ...
    <title>Welcome to FinSight</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://fin-sight-swart.vercel.app/assets/images/logo.png" alt="FinSight Logo" width="120" style="display:block;margin-bottom:16px">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                            <img src="https://fin-sight-swart.vercel.app/assets/images/dashboard.png" alt="FinSight Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               FinSight HQ, 200 Market Street, San Francisco, CA 94105<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app" style="color: #CCDADC !important; text-decoration: underline;">Visit FinSight</a><br>
                                © 2025 FinSight
                            </p>
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to FinSight news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app" style="color: #CCDADC !important; text-decoration: underline;">Visit FinSight</a>
                                </p>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; color: #000000; background-color: #E8BA40; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app/sign-in" style="color: #CCDADC !important; text-decoration: underline;">Visit FinSight</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 FinSight
                                </p>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; background-color: #E8BA40; color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="https://fin-sight-a4bn6s6rr-mohaneds-projects-a54ad9d1.vercel.app/sign-in" style="display: inline-block; background-color: #E8BA40; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited FinSight in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit FinSight</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 FinSight
                                </p>
